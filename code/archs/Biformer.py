...
class BiLevelRoutingAttention(nn.Module):
    ...
    def __init__(self, dim, num_heads=8, n_win=7, qk_dim=None, qk_scale=None,
        ...
        self.dw5 = nn.Conv2d(dim , dim , kernel_size=3, stride=1, padding=1, groups=dim)
    ...
    def forward(self, x, ret_attn_mask=False):
        ...
        dw5 = self.dw5(rearrange(kv[..., self.qk_dim:], 'n (j i) h w c -> n c (j h) (i w)', j=self.n_win, i=self.n_win).contiguous())
        dw5 = rearrange(dw5, 'n c (j h) (i w) -> n (j h) (i w) c', j=self.n_win, i=self.n_win)
