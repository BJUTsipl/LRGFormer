...
class CSWinTransformer(nn.Module):
    ...
    """
    def __init__(self, img_size=224, patch_size=16, in_chans=3,embed_dim=96, depth=[2,2,6], split_size = [3,5],
        ...
        self.PositionalEncoding = PositionalEncoding(num_pos_feats_x=32, num_pos_feats_y=32, num_pos_feats_z=32)  # (num_pos_feats_x=None, num_pos_feats_y=None, num_pos_feats_z=32)#
