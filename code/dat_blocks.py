...
class DAttentionBaseline(nn.Module):
    ...
    def forward(self, x):
        ...
        q = q.reshape(B , self.n_head_channels, H * W)#* self.n_heads
        k = self.proj_k(x_sampled).reshape(B , self.n_head_channels, n_sample)#* self.n_heads
        v = self.proj_v(x_sampled).reshape(B , self.n_head_channels, n_sample) #* self.n_heads
